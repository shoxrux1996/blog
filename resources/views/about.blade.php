    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="feature">
                ...
                <a href="ask-question.html">Задать вопрос юристам >></a>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="feature">
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="feature">
                ...
                <a href="order-call.html">Онлайн консультация >></a>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="feature">
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="feature">
                ...
                <a href="order-document.html">Заказать документ >></a>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="feature">
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="feature">
                ...
                <a href="lawyers.html">Выбрать юриста >></a>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="feature">
