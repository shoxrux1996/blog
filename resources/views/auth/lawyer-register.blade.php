    ...
    <div class="row" id="register-bg">
        <div class="col-md-7 col-sm-10 col-xs-12">
            ...
            <ul class="nav nav-tabs">
                <li><a data-toggle="tab" href="{{ route('user.register', ['user'=>'client'])}}">Клиент</a></li>
                <li class="active"><a data-toggle="tab" href="{{ route('user.register', ['user'=>'lawyer'])}}">Юрист</a></li>
                <li><a data-toggle="tab" href="{{ route('user.register', ['user'=>'company'])}}">Компания</a></li>
            </ul>

            <div class="tab-content">
                <div id="lawyer" class="tab-pane fade in active">
                    ...
                    <form method="POST" action="{{ route('user.register.submit', ['user'=>'lawyer']) }}">
                    {{ csrf_field() }}
