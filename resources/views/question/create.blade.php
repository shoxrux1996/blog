        ...
        <div class="container">
            ...
            <div class="row" id="how-it-works">
                ...
                <div class="col-sm-3 text-primary">
                    <h5 class="text-primary"><span class="label label-primary">1</span> @lang('question.Задайте вопрос')
                    </h5>
                ...
                <div class="col-sm-3 text-success">
                    <h5 class="text-success"><span
                                class="label label-success">3</span> @lang('question.Проблема решена!')</h5>
            ...
            <!-- Question submit form -->
                    ...
                    <div class="col-sm-7">
                        <div class="form-group">
                            ...
                            <label class="checkbox-inline">
                                <input type="radio" id="inlineCheckbox1" value="1" name="radio"
                                       checked> @lang('question.Частное лицо')
                            </label>
                            <label class="checkbox-inline">
                                <input type="radio" id="inlineCheckbox2" value="2"
                                       name="radio"> @lang('question.Представитель бизнеса')
                            </label>
                        </div>
                ...
                @if(!Auth::guard('client')->check())
                    <div class="row ask-form">
                        ...
                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}" id="name-div"
                             style="display:{{ $errors->has('name')  ? 'block' : '' }};">
                            ...
                            @endif
                            <input type="text" class="form-control general-input" name="name"
                                   placeholder="{{ __('question.Введите вашу имя') }}">
                        </div>
                        <div class="form-group{{ $errors->has('email') || $errors->has('wrong-attempt') ? ' has-error' : '' }}">
                            <label for="username"><i class="fa fa-envelope-o"
                                                     aria-hidden="true"></i> @lang('question.Эл. почта')</label>
                            @if ($errors->has('email'))
                                <span class="help-block">
                        ...
                        <div class="form-group{{ $errors->has('password') || $errors->has('wrong-attempt') || $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            <label for="password"><i class="fa fa-lock" aria-hidden="true"></i> @lang('question.Пароль')
                            </label>
                            ...
                            @endif
                            <input type="password" class="form-control general-input" name="password"
                                   placeholder="{{ __('question.Введите новую пароль') }}">
                        </div>
                        <div class="form-group" id="password-confirm-div">
                            <label for="password-confirm"><i class="fa fa-lock"
                                                             aria-hidden="true"></i> @lang('question.Повторите пароль')
                            </label>
                            <input type="password" class="form-control general-input" name="password_confirmation"
                                   placeholder="{{ __('question.Введите заново новую пароль') }}">
                        </div>
                    </div>
            @endif
