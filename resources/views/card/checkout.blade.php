        ...
        <section id="payment-payment" class="section-group">
            ...
            <td class="list-view grid" id="payment-grid">
                <table class="table table-striped">
                    ...
                    <tr>
                        <td class="td">#365087</td>
                        <td class="td">http://player.uz - Месячная подписка PLAYER FULL</td>
                        <td class="td">2017-04-08 19:52:02</td>
                        <td class="td"><span class="sign">-</span> 5,000.00</td>
                    </tr>
                </table>
